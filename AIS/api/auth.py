...
class Auth(object):
    ...
    def app_sign(self, expired=0):
        ...
        plain_text = 'a=' + self._appid + '&k=' + self._secret_id + '&e=' + str(expired) + '&t=' + str(
            now) + '&r=' + str(rdm) + '&u=' + puserid + '&f='
...
if __name__ == '__main__':
    auth =Auth(secret_id='inoGXeDiuPcdxGELzAMdf4xpg7iJxICy',secret_key='V8T-BQ6iVkwbU-RG2oX1EKpnfVDkMqi8',appid='657225',userid='kenwood')
    print(auth.app_sign())